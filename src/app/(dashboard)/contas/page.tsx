      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="bg-yellow-50 border-yellow-200">
          <CardContent className="p-3 text-center">
            ...
            <p className="text-sm font-bold text-yellow-700">{formatCurrency(totalPendentes)}</p>
          </CardContent>
        </Card>
        <Card className="bg-red-50 border-red-200">
          <CardContent className="p-3 text-center">
            ...
            <p className="text-sm font-bold text-red-700">{formatCurrency(totalAtrasadas)}</p>
          </CardContent>
        </Card>
      </div>
